...
4) Point Doubling will calculate 2p given p. Note that doing this again with 2p will provide 4p. If you want an odd doubling you must, add p to the current doubled p.
5) Evaluate all points on the curve will print all of the x,y coordinates within the curve. If your curve is over the real numbers, there is an infnite number of possible points, thus the program will simply print the identity of the curve, infinity.
